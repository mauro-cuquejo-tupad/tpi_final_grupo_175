 ...
 */
/**
 * Data Access Object para la entidad Pedidos.
 * Gestiona todas las operaciones de persistencia de pedidos en la base de datos.
 *
 */
public class PedidosDAO implements GenericDAO <Pedidos, Long> {
     ...
     /* Query de inserción de pedido.*/
       ...
       */
        ...
        /**
         ...
         LEFT JOIN con envio para cargar la relación de forma eager.
        ...
        */
        ...
        /**
         * Constructor con inyección de EnviosDAO.
    ...
    /// @throws java.lang.Exception
       ...
       public void insertar(Pedidos pedido) throws Exception {
         ...
         * NO cierra la conexión (responsabilidad del caller, ej. un TransactionManager).
         *
         * Usado por:
         * - Operaciones que requieren múltiples inserts coordinados (ej. Pedido + Envío)
         ...
         * NO actualiza el flag 'eliminado'.
         *
         * Validaciones:
         * - Si rowsAffected == 0 → El pedido no existe o ya está eliminado (y no se puede encontrar).
         *
         * IMPORTANTE: Este método puede cambiar las FKs:
         * - Si pedido.estado == null → id_estado_pedido = NULL (desasociar)
         * - Si pedido.envio == null → id_envio = NULL (desasociar)
         *
...
/**
     ...
     * Incluye su envío asociado mediante LEFT JOIN (carga eager).
     *
     * @param id ID del pedido a buscar
     * @return Pedido encontrado con su envío, o null si no existe o está eliminado
...
/**
     ...
     */
         ...
         *
         * @param filtro Texto a buscar en el nombre del cliente (no puede estar vacío)
        ...
        /**
        * Método privado para "setear" todos los parámetros del PreparedStatement de inserción.
        */
        ...
        // --- Manejo de FK para el Envío (Objeto) ---
            ...
            /**
            * Método privado para recuperar el ID autogenerado y guardarlo en el objeto 'pedido'.
            */
        ...
        /**
         * Método helper para mapear un ResultSet a un objeto Pedidos.
         * Está diseñado para manejar el LEFT JOIN de la consulta SELECT_BY_ID_SQL.
         *
