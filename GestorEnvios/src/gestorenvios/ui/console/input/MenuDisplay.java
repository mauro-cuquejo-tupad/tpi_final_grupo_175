...
public class MenuDisplay {
    ...
    public static void mostrarMenuPrincipal() {
        ...
        System.out.println("  7  - Eliminar pedido por número");
        System.out.println("  8  - Eliminar pedido por ID");
        System.out.println();
        System.out.println("ENVIOS");
        System.out.println(" 9   - Crear envío");
        System.out.println(" 10  - Listar envíos");
        System.out.println(" 11  - Buscar envío por tracking");
        System.out.println(" 12  - Buscar envío por número de pedido");
        System.out.println(" 13  - Buscar envío por ID");
        System.out.println(" 14  - Actualizar estado envío por tracking");
        System.out.println(" 15  - Actualizar estado envío por número de pedido");
        System.out.println(" 16  - Actualizar estado envío por ID");
        System.out.println(" 17  - Eliminar envío por tracking");
        System.out.println(" 18  - Eliminar envío por número de pedido");
        System.out.println(" 19  - Eliminar envío por ID");
        System.out.println();
