...
public class MenuDisplay {
    ...
    public static void mostrarMenuPrincipal() {
        ...
        System.out.println("  8  - Actualizar pedido por ID");
        System.out.println("  9  - Eliminar pedido por número");
        System.out.println("  10 - Eliminar pedido por ID");
        System.out.println("  11 - Eliminar Envio de pedido");
        System.out.println();
        System.out.println("ENVIOS");
        System.out.println(" 12  - Crear envío");
        System.out.println(" 13  - Listar envíos");
        System.out.println(" 14  - Buscar envío por tracking");
        System.out.println(" 15  - Buscar envío por número de pedido");
        System.out.println(" 16  - Buscar envío por ID");
        System.out.println(" 17  - Actualizar envío por tracking");
        System.out.println(" 18  - Actualizar envío por número de pedido");
        System.out.println(" 19  - Actualizar envío por ID");
        System.out.println(" 20  - Eliminar envío por tracking");
        System.out.println(" 21  - Eliminar envío por número de pedido");
        System.out.println(" 22  - Eliminar envío por ID");
        System.out.println();
